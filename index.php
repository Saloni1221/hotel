...
Welcome to Sunrise Hotel, where every day begins with a breathtaking experience. Nestled amidst picturesque landscapes, Sunrise Hotel is a luxurious haven designed to provide guests with an unforgettable stay.</p>
						   <img src="images/about.jpg" class="img-responsive" alt="Hair Salon">
                                       ...
                                       <div class="w3ls-info-about">
											...
											<p>As the name suggests, our hotel is renowned for its spectacular sunrise views </p>
										</div>
		          </div>
		   	<div class="clearfix"> </div>
    </div>
			 ...
			 <div class="col-md-6 advantage-grid left-w3ls wow bounceInLeft" data-wow-delay="0.3s">
			 	<div class="advantage-block ">
					<i class="fa fa-credit-card" aria-hidden="true"></i>
			 		...
			 		<p>"Enjoy your stay without worrying about payment until check-out."</p>
			 ...
			 <div class="col-md-6 advantage-grid right-w3ls wow zoomIn" data-wow-delay="0.3s">
			 	<div class="advantage-block">
					<i class="fa fa-clock-o" aria-hidden="true"></i>
			 		...
			 		<p>Satisfy your cravings any time of the day at our 24-hour restaurant.</p>
						...
						<div class="price-gd-bottom">
							<div class="price-list">
								<ul>
									...
									<li><i class="fa fa-star" aria-hidden="true"></i></li>
									<li><i class="fa fa-star-o" aria-hidden="true"></i></li>
									<li><i clas₹s="fa fa-star-o" aria-hidden="true"></i></li>
								</ul>
							</div>
							<div class="price-selet">
								<h3><span>₹</span>180</h3>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+91 7796383639</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="info@sunrise.com">INFO@SUNRISE.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong> Shivaji Chawk,Talegaon,Pune,India</p>
